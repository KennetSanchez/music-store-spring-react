export const Input = (
    ...
    const primaryStyleStates : string = `transition delay-100 ease-in-out hover:border-b-purple-800 focus:outline-none focus:border-b-purple-400 autofill:bg-purple-400`;
